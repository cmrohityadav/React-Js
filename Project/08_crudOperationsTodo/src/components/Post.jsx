        ...
        <>
            <form onSubmit={handlePost} >
                <div className="lx yz ze alm aqv">
                    ...
                    <button type='submit' className='inline-block rounded border mt-4  border-red-800 bg-red-800 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-green-600 focus:outline-none focus:ring active:text-indigo-500 cursor-pointer' >Post</button>
                </div>
            </form>
                  <a
